...
function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <SEO title="About Us" description="Learn more about TechPad - premium PC accessories and peripherals." />
      <Header />
      <main id="main-content" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 flex-1 w-full">
        <h1 className="text-3xl font-bold text-surface-900 mb-6">About Us</h1>
